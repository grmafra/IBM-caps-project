...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.Div(["Dropdown Menu",dcc.Dropdown(id='site-dropdown',options = options,value='ALL', placeholder="Select a Launch Site here",searchable=True)]),
                                html.Br(),
                                ...
                                html.Div(dcc.RangeSlider(id='payload-slider', min=0, max=10000, step=1000, marks={0: '0', 2500: '2500', 5000: '5000', 7500:'7500', 10000:'10000'}, value=[0, 10000])),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values='class count', names='Launch Site', title='Total Success Launch by Site')
        return fig
    else:
        ...
        title = 'Total Success Launch for ' + str(entered_site)
